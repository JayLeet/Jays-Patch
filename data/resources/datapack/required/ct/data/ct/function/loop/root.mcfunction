...
scoreboard players enable @a setup_sign
execute as @a[scores={setup_sign=1}] run function ct:setup_sign/become_storyteller
execute as @a[scores={setup_sign=2}] run function ct:setup_sign/sit_player
scoreboard players set @a[scores={setup_sign=1..}] setup_sign 0
