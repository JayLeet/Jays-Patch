...
execute if score player_count game_data matches 5..15 run tellraw @a[tag=storyteller] [{"text":"! ","color":"yellow","bold":true},{"text":"Town square winner buttons: ","color":"gray","bold":false},{"text":"light blue","color":"aqua","bold":true},{"text":" shows the Good team, and ","color":"gray","bold":false},{"text":"red","color":"red","bold":true},{"text":" shows the Evil team. Press one after the game to show who won for about 1 minute.","color":"gray","bold":false}]
