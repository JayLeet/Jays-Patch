...
execute if score phase game_data matches 4 as @a[tag=botc_patch_night_chat,tag=botc_wraith_observing] at @s run function botc_patch:night_chat/leave_silent
...
execute if score patch_items_enabled botc_patch matches 1 if score phase game_data matches 4 as @a[tag=botc_patch_night_chat,tag=in_house,tag=!storyteller,tag=!spectator,tag=!botc_wraith_observing,scores={id=1..15}] if data entity @s SelectedItem.components."minecraft:custom_data"{botc_night_chat_tool:1b} unless score @s botc_night_chat_seen = @s botc_leave_game at @s run function botc_patch:night_chat/rejoin
execute if score patch_items_enabled botc_patch matches 1 if score phase game_data matches 4 as @a[tag=botc_patch_night_chat,tag=in_house,tag=!storyteller,tag=!spectator,tag=!botc_wraith_observing,scores={id=1..15}] unless data entity @s SelectedItem.components."minecraft:custom_data"{botc_night_chat_tool:1b} at @s run function botc_patch:night_chat/leave_silent
execute if score patch_items_enabled botc_patch matches 1 if score phase game_data matches 4 as @a[tag=!botc_patch_night_chat,tag=in_house,tag=!storyteller,tag=!spectator,tag=!botc_wraith_observing,scores={id=1..15}] if data entity @s SelectedItem.components."minecraft:custom_data"{botc_night_chat_tool:1b} at @s run function botc_patch:night_chat/join
