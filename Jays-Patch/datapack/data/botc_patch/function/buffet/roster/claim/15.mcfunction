...
data modify storage botc_patch:buffet greedy.seats.s15 set value {active:1b,name:"Seat 15",status:0,submitted:0b,dealer:0b,role:0,perceived:0,alignment:0,perceived_alignment:0,override:0b,choices:{}}
