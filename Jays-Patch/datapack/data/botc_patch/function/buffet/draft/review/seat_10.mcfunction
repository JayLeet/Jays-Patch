...
# Prepare private Draft history for seat 10.
data modify storage botc_patch:buffet ui.player set from storage botc_patch:buffet draft.seats.s10.name
...
execute if data storage botc_patch:buffet draft.seats.s10.history.r1.o1.name run data modify storage botc_patch:buffet ui.r1o1 set from storage botc_patch:buffet draft.seats.s10.history.r1.o1.name
execute if data storage botc_patch:buffet draft.seats.s10.history.r1.o2.name run data modify storage botc_patch:buffet ui.r1o2 set from storage botc_patch:buffet draft.seats.s10.history.r1.o2.name
execute if data storage botc_patch:buffet draft.seats.s10.history.r2.o1.name run data modify storage botc_patch:buffet ui.r2o1 set from storage botc_patch:buffet draft.seats.s10.history.r2.o1.name
