...
# Begin the reserved fake_atheist player flow without exposing trusted route state.
...
function botc_patch:buffet/draft/atheist/offer_fake with storage botc_patch:buffet action
