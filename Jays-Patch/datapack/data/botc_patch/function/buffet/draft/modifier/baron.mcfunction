...
# Apply the baron setup modifier.
execute store result storage botc_patch:buffet modifier.seat int 1 run scoreboard players get @s id
data modify storage botc_patch:buffet modifier.town set value -2
data modify storage botc_patch:buffet modifier.outsider set value 2
