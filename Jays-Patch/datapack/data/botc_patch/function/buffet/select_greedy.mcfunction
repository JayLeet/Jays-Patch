...
title @a[tag=botc_buffet_roster] subtitle {"text":"Townsfolk, Outsiders, Minions and Demons.","color":"gray"}
title @a[tag=botc_buffet_roster] title {"text":"Choose at least 2 of each type.","color":"gold","bold":true}
