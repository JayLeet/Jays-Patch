...
execute unless data storage botc_patch:setup import_candidate[0] run tellraw @s [{"text":"! ","color":"red","bold":true},{"text":"Setup import failed: expected a non-empty script list.","color":"gray","bold":false}]
