...
execute unless data storage botc_patch:setup import_candidate[0] run return run tellraw @s [{"text":"! ","color":"red","bold":true},{"text":"Setup import failed: expected a script list.","color":"gray","bold":false}]
