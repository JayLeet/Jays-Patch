# Generated symmetric 6-player town-square layout. Seat 1 is north; IDs proceed clockwise.
...
data modify block 133 72 60 front_text.messages[1] set value {"selector":"@a[team=02_orange]","color":"#f58231"}
setblock 134 73 60 minecraft:white_wall_banner[facing=west]
data modify block 134 73 60 patterns set value [{pattern:"ct:orange",color:"white"}]
...
data modify block 127 72 71 front_text.messages[1] set value {"selector":"@a[team=04_lime]","color":"#bfef45"}
setblock 127 73 72 minecraft:white_wall_banner[facing=north]
data modify block 127 73 72 patterns set value [{pattern:"ct:lime",color:"white"}]
...
data modify block 121 72 60 front_text.messages[1] set value {"selector":"@a[team=06_mint]","color":"#aaffc3"}
setblock 120 73 60 minecraft:white_wall_banner[facing=east]
data modify block 120 73 60 patterns set value [{pattern:"ct:mint",color:"white"}]
...
tp @e[type=minecraft:item_display,tag=vote_marker,tag=botc_seat_marker_2,limit=1] 134.5 76 60.5
data modify entity @e[type=minecraft:item_display,tag=vote_marker,tag=botc_seat_marker_2,limit=1] transformation.left_rotation set value [0f,0.864910093118595f,0f,0.501926818193233f]
...
tp @e[type=minecraft:item_display,tag=vote_marker,tag=botc_seat_marker_3,limit=1] 134.5 76 68.5
data modify entity @e[type=minecraft:item_display,tag=vote_marker,tag=botc_seat_marker_3,limit=1] transformation.left_rotation set value [0f,0.501926818193233f,0f,0.864910093118595f]
...
tp @e[type=minecraft:item_display,tag=vote_marker,tag=botc_seat_marker_4,limit=1] 127.5 76 72.5
data modify entity @e[type=minecraft:item_display,tag=vote_marker,tag=botc_seat_marker_4,limit=1] transformation.left_rotation set value [0f,0f,0f,1f]
...
tp @e[type=minecraft:item_display,tag=vote_marker,tag=botc_seat_marker_5,limit=1] 120.5 76 68.5
...
tp @e[type=minecraft:item_display,tag=vote_marker,tag=botc_seat_marker_6,limit=1] 120.5 76 60.5
data modify entity @e[type=minecraft:item_display,tag=vote_marker,tag=botc_seat_marker_6,limit=1] transformation.left_rotation set value [0f,-0.864910093118595f,0f,0.501926818193233f]
...
scoreboard players set seat_layout_active_count botc_patch 6
