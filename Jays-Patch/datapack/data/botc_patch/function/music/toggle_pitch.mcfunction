...
execute if entity @s[tag=botc_music_pitch_was_normal] run tellraw @s [{"text":"Night music pitch is low.","color":"gray"}]
execute unless entity @s[tag=botc_music_pitch_was_normal] run tag @s add botc_music_normal
execute unless entity @s[tag=botc_music_pitch_was_normal] run tellraw @s [{"text":"Night music pitch is normal.","color":"aqua"}]
tag @s remove botc_music_pitch_was_normal
