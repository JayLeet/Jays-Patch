...
item replace entity @s hotbar.5 with minecraft:carrot_on_a_stick[minecraft:custom_model_data={strings:["grim_reveal_menu"]},minecraft:custom_data={botc_patch_tool:1b},custom_name=[{text:"Reveal Grimoire",color:"gold",bold:true,italic:false}]]
