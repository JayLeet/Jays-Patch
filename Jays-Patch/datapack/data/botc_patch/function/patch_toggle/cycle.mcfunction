...
execute if score patch_items_enabled botc_patch matches 1 if score patch_setup_bag_enabled botc_patch matches 1 run tag @s add botc_patch_toggle_to_sybillian
