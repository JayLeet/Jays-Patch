...
tellraw @s [{"text":"\u2714 ","color":"green","bold":true},{"text":"Sybillian's setup bag","color":"gold","bold":true},{"text":" is on. Right-click again to turn off Jay's held items.","color":"gray","bold":false}]
