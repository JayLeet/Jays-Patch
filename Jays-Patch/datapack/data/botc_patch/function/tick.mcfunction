...
execute if score phase game_data matches 1.. as @a[tag=!storyteller] unless score @s game_id = active_game game_id run function botc_patch:reset/active_game_outsider_state
