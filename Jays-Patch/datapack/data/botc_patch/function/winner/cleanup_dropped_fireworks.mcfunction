...
execute as @e[type=minecraft:item] if items entity @s contents minecraft:carrot_on_a_stick[minecraft:custom_data~{botc_patch_winner_firework:1b}] run kill @s
