...
# The centre trail forms the handle; these widening side trails form its outer tines.
execute if score @s botc_fun_hot_range matches 15..16 if block ~ ~ ~ #minecraft:replaceable run particle minecraft:flame ^-0.08 ^ ^ 0 0 0 0 1 force @a[distance=..32]
execute if score @s botc_fun_hot_range matches 15..16 if block ~ ~ ~ #minecraft:replaceable run particle minecraft:flame ^0.08 ^ ^ 0 0 0 0 1 force @a[distance=..32]
execute if score @s botc_fun_hot_range matches 13..14 if block ~ ~ ~ #minecraft:replaceable run particle minecraft:flame ^-0.16 ^ ^ 0 0 0 0 1 force @a[distance=..32]
execute if score @s botc_fun_hot_range matches 13..14 if block ~ ~ ~ #minecraft:replaceable run particle minecraft:flame ^0.16 ^ ^ 0 0 0 0 1 force @a[distance=..32]
execute if score @s botc_fun_hot_range matches 1..12 if block ~ ~ ~ #minecraft:replaceable run particle minecraft:flame ^-0.24 ^ ^ 0 0 0 0 1 force @a[distance=..32]
execute if score @s botc_fun_hot_range matches 1..12 if block ~ ~ ~ #minecraft:replaceable run particle minecraft:flame ^0.24 ^ ^ 0 0 0 0 1 force @a[distance=..32]
execute if block ~ ~ ~ #minecraft:replaceable positioned ~-0.1 ~-0.1 ~-0.1 if entity @a[tag=storyteller,tag=!botc_fun_hot_holder,gamemode=!spectator,dx=0.2,dy=0.2,dz=0.2,limit=1,sort=nearest] run scoreboard players set @s botc_fun_hot_range 0
