...
execute if score @s botc_fun_hot_range matches 7..8 if block ~ ~ ~ #minecraft:replaceable run particle minecraft:flame ^-0.08 ^ ^ 0 0 0 0 1 force @a[distance=..32]
execute if score @s botc_fun_hot_range matches 7..8 if block ~ ~ ~ #minecraft:replaceable run particle minecraft:flame ^0.08 ^ ^ 0 0 0 0 1 force @a[distance=..32]
execute if score @s botc_fun_hot_range matches 5..6 if block ~ ~ ~ #minecraft:replaceable run particle minecraft:flame ^-0.16 ^ ^ 0 0 0 0 1 force @a[distance=..32]
execute if score @s botc_fun_hot_range matches 5..6 if block ~ ~ ~ #minecraft:replaceable run particle minecraft:flame ^0.16 ^ ^ 0 0 0 0 1 force @a[distance=..32]
execute if score @s botc_fun_hot_range matches 1..4 if block ~ ~ ~ #minecraft:replaceable run particle minecraft:flame ^-0.24 ^ ^ 0 0 0 0 1 force @a[distance=..32]
execute if score @s botc_fun_hot_range matches 1..4 if block ~ ~ ~ #minecraft:replaceable run particle minecraft:flame ^0.24 ^ ^ 0 0 0 0 1 force @a[distance=..32]
