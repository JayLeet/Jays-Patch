# Vertical 5x5 footprint for north/south-facing walls.
execute positioned ~-2 ~-2 ~ if block ~ ~ ~ #botc_patch:paintable_full_cube run summon minecraft:marker ~ ~ ~ {Tags:["botc_fun_paint_candidate","botc_fun_paint_preferred"]}
...
execute positioned ~-2 ~ ~ if block ~ ~ ~ #botc_patch:paintable_full_cube run summon minecraft:marker ~ ~ ~ {Tags:["botc_fun_paint_candidate","botc_fun_paint_preferred"]}
execute positioned ~-2 ~1 ~ if block ~ ~ ~ #botc_patch:paintable_full_cube run summon minecraft:marker ~ ~ ~ {Tags:["botc_fun_paint_candidate","botc_fun_paint_preferred"]}
execute positioned ~-2 ~2 ~ if block ~ ~ ~ #botc_patch:paintable_full_cube run summon minecraft:marker ~ ~ ~ {Tags:["botc_fun_paint_candidate","botc_fun_paint_preferred"]}
