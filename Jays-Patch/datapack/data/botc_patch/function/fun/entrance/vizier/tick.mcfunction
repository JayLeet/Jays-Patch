...
execute if score fun_entrance_timer botc_patch matches 55 run playsound minecraft:block.note_block.chime master @a[distance=..64] ~ ~ ~ 1.1 0.85
execute if score fun_entrance_timer botc_patch matches 40 run playsound minecraft:block.note_block.bell master @a[distance=..64] ~ ~ ~ 1.1 0.70
execute if score fun_entrance_timer botc_patch matches 25 run playsound minecraft:block.note_block.chime master @a[distance=..64] ~ ~ ~ 1.2 0.60
execute if score fun_entrance_timer botc_patch matches 10 run playsound minecraft:entity.player.levelup master @a[distance=..64] ~ ~ ~ 1.3 0.50
