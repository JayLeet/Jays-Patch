...
execute unless entity @s[tag=botc_st_post_kill_done] unless entity @a[tag=botc_st_last_executed,limit=1] run tellraw @s [{text:"No executed player is stored.",color:"red"}]
tag @s remove botc_st_post_kill_done
