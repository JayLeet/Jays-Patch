...
execute unless score phase game_data matches 1..4 run tellraw @s [{text:"! ",color:"red",bold:true},{text:"Storyteller Tools aren't available in this phase.",color:"gray",bold:false}]
