...
execute if score phase game_data matches 3 if entity @s[tag=botc_st_post_execution] if entity @a[tag=botc_st_last_executed,scores={id=1..15,role=107}] run scoreboard players set grim_notice_boomdandy_seen botc_patch 1
