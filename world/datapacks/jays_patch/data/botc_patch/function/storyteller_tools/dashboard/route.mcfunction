...
execute if score @s botc_st_dialog matches 16 if score phase game_data matches 1..3 run function botc_patch:storyteller_tools/kill_menu/open
...
execute if score @s botc_st_dialog matches 23 if score phase game_data matches 3 if entity @s[tag=botc_st_post_execution] if entity @a[tag=botc_st_last_executed,scores={id=1..15,role=107}] run function botc_patch:storyteller_tools/post_execution/boomdandy
