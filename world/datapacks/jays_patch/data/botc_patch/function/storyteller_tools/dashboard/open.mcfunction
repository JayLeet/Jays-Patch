...
execute if score phase game_data matches 3 if entity @s[tag=botc_st_post_execution,tag=botc_st_post_kill_resolved] if entity @a[tag=!storyteller,tag=!spectator,scores={id=1..15,role=107}] run function botc_patch:storyteller_tools/dashboard/post_execution_resolved_boomdandy with storage botc_patch:grim notifications
execute if score phase game_data matches 3 if entity @s[tag=botc_st_post_execution,tag=botc_st_post_kill_resolved] unless entity @a[tag=!storyteller,tag=!spectator,scores={id=1..15,role=107}] run function botc_patch:storyteller_tools/dashboard/post_execution_resolved with storage botc_patch:grim notifications
execute if score phase game_data matches 3 if entity @s[tag=botc_st_post_execution,tag=!botc_st_post_kill_resolved] if entity @a[tag=!storyteller,tag=!spectator,scores={id=1..15,role=107}] run function botc_patch:storyteller_tools/dashboard/post_execution_boomdandy with storage botc_patch:grim notifications
execute if score phase game_data matches 3 if entity @s[tag=botc_st_post_execution,tag=!botc_st_post_kill_resolved] unless entity @a[tag=!storyteller,tag=!spectator,scores={id=1..15,role=107}] run function botc_patch:storyteller_tools/dashboard/post_execution with storage botc_patch:grim notifications
