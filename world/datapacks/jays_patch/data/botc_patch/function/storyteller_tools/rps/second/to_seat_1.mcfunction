...
# Starts Sybillian RPS between the stored first player and ready player in seat 1.
dialog clear @s
...
execute unless entity @a[tag=!botc_rps_first,tag=!storyteller,tag=!spectator,tag=!dead,scores={id=1,rps=1..3},limit=1] run return run tellraw @s [{text:"! ",color:"red",bold:true},{text:"That opponent is no longer available for RPS.",color:"gray",bold:false}]
...
tag @a[tag=!botc_rps_first,tag=!storyteller,tag=!spectator,tag=!dead,scores={id=1,rps=1..3},limit=1] add playing_rps
