...
item replace entity @s hotbar.6 with minecraft:carrot_on_a_stick[minecraft:custom_model_data={strings:["grim_reveal_menu"]},minecraft:custom_data={botc_patch_tool:1b},custom_name=[{text:"Storyteller Tools",color:"gold",bold:true,italic:false}]]
execute if entity @a[tag=!storyteller,tag=!spectator,scores={id=1..15,role=107}] unless score patch_dialog_mode botc_patch matches 1 run item replace entity @s hotbar.2 with minecraft:carrot_on_a_stick[minecraft:custom_model_data={strings:["botc_role_boomdandy"]},minecraft:custom_data={botc_patch_tool:1b},custom_name=[{text:"Boomdandy",color:"red",bold:true,italic:false},{text:" [Right-Click]",color:"gray",bold:false,italic:false}]]
