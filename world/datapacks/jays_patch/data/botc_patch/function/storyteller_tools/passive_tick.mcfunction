...
function botc_patch:storyteller_tools/boomdandy_pyre/tick
function botc_patch:storyteller_tools/boomdandy/tick
...
execute unless score phase game_data matches 1..3 as @a[tag=storyteller,tag=botc_st_kill_menu] run function botc_patch:storyteller_tools/kill_menu/close
