...
# Choose Legion total 5 through 9 for 9 players and a protected Outsider floor of 0.
execute store result score draft_legion_count botc_patch run random value 5..9
