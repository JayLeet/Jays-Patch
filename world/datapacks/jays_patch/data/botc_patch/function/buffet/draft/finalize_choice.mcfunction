...
$execute if data storage botc_patch:buffet action.choice.hermit_forced_ability run data modify storage botc_patch:buffet draft.seats.s$(seat).hermit_forced_ability set value $(hermit_forced_ability)
...
$execute if data storage botc_patch:buffet action.choice.hermit_forced_ability run scoreboard players set draft_chosen_$(hermit_forced_ability) botc_patch 1
$execute if data storage botc_patch:buffet action.choice.hermit_forced_ability run scoreboard players set draft_available_$(hermit_forced_ability) botc_patch 0
