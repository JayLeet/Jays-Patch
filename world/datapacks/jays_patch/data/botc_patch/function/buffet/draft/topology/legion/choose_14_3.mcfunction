...
# Choose Legion total 8 through 11 for 14 players and a protected Outsider floor of 3.
execute store result score draft_legion_count botc_patch run random value 8..11
