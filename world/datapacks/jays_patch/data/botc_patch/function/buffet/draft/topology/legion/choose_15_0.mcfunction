...
# Choose Legion total 8 through 15 for 15 players and a protected Outsider floor of 0.
execute store result score draft_legion_count botc_patch run random value 8..15
