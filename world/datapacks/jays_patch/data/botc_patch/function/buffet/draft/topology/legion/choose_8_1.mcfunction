...
# Choose Legion total 5 through 7 for 8 players and a protected Outsider floor of 1.
execute store result score draft_legion_count botc_patch run random value 5..7
