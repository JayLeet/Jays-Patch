...
# Choose Legion total 5 through 6 for 8 players and a protected Outsider floor of 2.
execute store result score draft_legion_count botc_patch run random value 5..6
