...
# Begin the reserved special player flow without exposing trusted route state.
...
function botc_patch:buffet/draft/special/start_real with storage botc_patch:buffet action
