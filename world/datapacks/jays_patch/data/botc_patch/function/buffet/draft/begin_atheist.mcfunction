...
# Begin the reserved atheist player flow without exposing trusted route state.
...
function botc_patch:buffet/draft/atheist/offer_real with storage botc_patch:buffet action
