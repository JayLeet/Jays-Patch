...
# Choose Legion total 6 through 6 for 11 players and a protected Outsider floor of 5.
execute store result score draft_legion_count botc_patch run random value 6..6
