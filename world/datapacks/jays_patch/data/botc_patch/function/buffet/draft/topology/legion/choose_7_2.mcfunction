...
# Choose Legion total 4 through 5 for 7 players and a protected Outsider floor of 2.
execute store result score draft_legion_count botc_patch run random value 4..5
