...
# Choose Legion total 8 through 10 for 14 players and a protected Outsider floor of 4.
execute store result score draft_legion_count botc_patch run random value 8..10
