...
# Choose Legion total 7 through 9 for 12 players and a protected Outsider floor of 3.
execute store result score draft_legion_count botc_patch run random value 7..9
