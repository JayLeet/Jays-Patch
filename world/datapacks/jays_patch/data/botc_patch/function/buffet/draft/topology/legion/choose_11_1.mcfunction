...
# Choose Legion total 6 through 10 for 11 players and a protected Outsider floor of 1.
execute store result score draft_legion_count botc_patch run random value 6..10
