...
execute unless score buffet_submit_valid botc_patch matches 1 run function botc_patch:buffet/greedy/open
...
function botc_patch:buffet/greedy/recount
tellraw @s [{"text":"✓ ","color":"green","bold":true},{"text":"Your choices were sent to the Storyteller. You may still edit and resubmit them.","color":"gray","bold":false}]
