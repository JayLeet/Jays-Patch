...
# Assign the acting player to open Buffet seat 15.
...
data modify storage botc_patch:buffet greedy.seats.s15 set value {active:1b,name:"Seat 15",status:0,submitted:0b,resubmit_requested:0b,dealer:0b,role:0,perceived:0,alignment:0,perceived_alignment:0,override:0b,choices:{}}
execute if score buffet_roster_count botc_patch matches ..14 run scoreboard players set buffet_roster_count botc_patch 15
