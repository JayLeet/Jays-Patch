...
# Prepare the Storyteller grimoire overlay for a hidden lunatic player.
data modify storage botc_patch:buffet hidden_grim set value {seat:0,perceived:0,role:"none",reminder:"lunatic"}
