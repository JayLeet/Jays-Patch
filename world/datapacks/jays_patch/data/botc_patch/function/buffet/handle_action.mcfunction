...
execute if score phase game_data matches 0 if score buffet_mode botc_patch matches 1 if entity @s[tag=botc_buffet_roster,tag=!storyteller] if score @s botc_buffet_action matches 11 run function botc_patch:buffet/greedy/dialog/town_prepare
execute if score phase game_data matches 0 if score buffet_mode botc_patch matches 1 if entity @s[tag=botc_buffet_roster,tag=!storyteller] if score @s botc_buffet_action matches 12 run function botc_patch:buffet/greedy/dialog/outsider_prepare
execute if score phase game_data matches 0 if score buffet_mode botc_patch matches 1 if entity @s[tag=botc_buffet_roster,tag=!storyteller] if score @s botc_buffet_action matches 13 run function botc_patch:buffet/greedy/dialog/minion_prepare
execute if score phase game_data matches 0 if score buffet_mode botc_patch matches 1 if entity @s[tag=botc_buffet_roster,tag=!storyteller] if score @s botc_buffet_action matches 14 run function botc_patch:buffet/greedy/dialog/demon_prepare
execute if score phase game_data matches 0 if score buffet_mode botc_patch matches 1 if entity @s[tag=botc_buffet_roster,tag=!storyteller] if score @s botc_buffet_action matches 15 run function botc_patch:buffet/greedy/toggle_dealer
execute if score phase game_data matches 0 if score buffet_mode botc_patch matches 1 if entity @s[tag=botc_buffet_roster,tag=!storyteller] if score @s botc_buffet_action matches 20 run function botc_patch:buffet/greedy/submit
...
execute if score phase game_data matches 0 if score buffet_mode botc_patch matches 1 if entity @s[tag=storyteller] if score @s botc_buffet_action matches 3004 run function botc_patch:buffet/greedy/start/execute
execute if score phase game_data matches 0 if score buffet_mode botc_patch matches 1 if entity @s[tag=storyteller] if score @s botc_buffet_action matches 3005 run function botc_patch:buffet/greedy/jinx/report
