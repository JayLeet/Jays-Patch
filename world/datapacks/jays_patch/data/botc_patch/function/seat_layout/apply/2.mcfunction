# Generated symmetric 2-player town-square layout. Seat 1 is north; IDs proceed clockwise.
...
data modify block 127 72 71 front_text.messages[1] set value {"selector":"@a[team=02_orange]","color":"#f58231"}
setblock 127 73 72 minecraft:white_wall_banner[facing=north]
data modify block 127 73 72 patterns set value [{pattern:"ct:orange",color:"white"}]
...
tp @e[type=minecraft:item_display,tag=vote_marker,tag=botc_seat_marker_2,limit=1] 127.5 76 72.5
data modify entity @e[type=minecraft:item_display,tag=vote_marker,tag=botc_seat_marker_2,limit=1] transformation.left_rotation set value [0f,0f,0f,1f]
...
scoreboard players set seat_layout_active_count botc_patch 2
