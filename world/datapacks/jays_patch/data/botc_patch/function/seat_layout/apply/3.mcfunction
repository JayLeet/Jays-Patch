# Generated symmetric 3-player town-square layout. Seat 1 is north; IDs proceed clockwise.
...
data modify block 133 72 68 front_text.messages[1] set value {"selector":"@a[team=02_orange]","color":"#f58231"}
setblock 134 73 68 minecraft:white_wall_banner[facing=west]
data modify block 134 73 68 patterns set value [{pattern:"ct:orange",color:"white"}]
...
data modify block 121 72 68 front_text.messages[1] set value {"selector":"@a[team=03_yellow]","color":"#ffe119"}
setblock 120 73 68 minecraft:white_wall_banner[facing=east]
data modify block 120 73 68 patterns set value [{pattern:"ct:yellow",color:"white"}]
...
tp @e[type=minecraft:item_display,tag=vote_marker,tag=botc_seat_marker_2,limit=1] 134.5 76 68.5
data modify entity @e[type=minecraft:item_display,tag=vote_marker,tag=botc_seat_marker_2,limit=1] transformation.left_rotation set value [0f,0.501926818193233f,0f,0.864910093118595f]
...
tp @e[type=minecraft:item_display,tag=vote_marker,tag=botc_seat_marker_3,limit=1] 120.5 76 68.5
...
scoreboard players set seat_layout_active_count botc_patch 3
