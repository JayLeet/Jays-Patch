...
function botc_patch:fun/paint_gun/tick
...
execute as @a[scores={botc_fun_item_use=1..,botc_fun_paint_cooldown=..0}] if data entity @s SelectedItem.components."minecraft:custom_model_data"{strings:["botc_fun_paint_gun"]} run function botc_patch:fun/paint_gun/shoot_normal
execute as @a[scores={botc_fun_item_use=1..,botc_fun_paint_cooldown=..0}] if data entity @s SelectedItem.components."minecraft:custom_model_data"{strings:["botc_fun_rainbow_paint_gun"]} run function botc_patch:fun/paint_gun/shoot_rainbow
