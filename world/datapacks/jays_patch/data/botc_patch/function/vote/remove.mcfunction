...
execute unless entity @s[tag=botc_vote_yes] run return run tellraw @s [{"text":"! ","color":"red","bold":true},{"text":"You have not voted in this votekick.","color":"gray","bold":false}]
