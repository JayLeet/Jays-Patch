...
tellraw @s [{"text":"\u2714 ","color":"green","bold":true},{"text":"Dialog mode","color":"yellow","bold":true},{"text":" is on. Right-click again for Sybillian's setup bag.","color":"gray","bold":false}]
