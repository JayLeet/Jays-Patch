...
tellraw @s [{"text":"\u2714 ","color":"green","bold":true},{"text":"Jay's held items","color":"red","bold":true},{"text":" are off. Storyteller Tools and this toggle still work. Right-click again to return to item mode.","color":"gray","bold":false}]
tellraw @s [{"text":"! ","color":"red","bold":true},{"text":"You need ","color":"gray","bold":false},{"text":"OP","color":"yellow","bold":true},{"text":" to start the game in this mode.","color":"gray","bold":false}]
