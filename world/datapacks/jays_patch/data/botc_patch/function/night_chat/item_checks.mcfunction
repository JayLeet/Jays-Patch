...
clear @a[tag=botc_wraith_observing] minecraft:carrot_on_a_stick[minecraft:custom_data={botc_patch_tool:1b,botc_night_chat_tool:1b}]
...
execute if score patch_items_enabled botc_patch matches 1 if score phase game_data matches 4 as @a[tag=in_house,tag=!storyteller,tag=!spectator,tag=!botc_wraith_observing,scores={id=1..15}] store result score @s botc_night_chat_items run clear @s minecraft:carrot_on_a_stick[minecraft:custom_data={botc_patch_tool:1b,botc_night_chat_tool:1b}] 0
execute if score patch_items_enabled botc_patch matches 1 if score phase game_data matches 4 as @a[tag=in_house,tag=!storyteller,tag=!spectator,tag=!botc_wraith_observing,scores={id=1..15}] unless score @s botc_night_chat_items matches 1 run tag @s add botc_night_chat_repair
execute if score patch_items_enabled botc_patch matches 1 if score phase game_data matches 4 as @a[tag=in_house,tag=!storyteller,tag=!spectator,tag=!botc_wraith_observing,scores={id=1..15}] unless data entity @s Inventory[{Slot:1b}].components."minecraft:custom_data"{botc_night_chat_tool:1b} run tag @s add botc_night_chat_repair
