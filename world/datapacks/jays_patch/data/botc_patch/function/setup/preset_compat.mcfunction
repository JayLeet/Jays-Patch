...
execute unless score setup_preset_payload_valid botc_patch matches 1 run return run tellraw @s [{"text":"! ","color":"red","bold":true},{"text":"Setup import failed: expected a script list or character list.","color":"gray","bold":false}]
