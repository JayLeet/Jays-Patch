...
tellraw @s [{"text":"\u2714 ","color":"green","bold":true},{"text":"Cleared the selected ","color":"gray","bold":false},{"text":"setup characters","color":"yellow","bold":true},{"text":".","color":"gray","bold":false}]
